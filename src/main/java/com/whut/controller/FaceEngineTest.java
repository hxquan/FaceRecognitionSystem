...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "FGDZGVMv5NL4ZU53p2E38w3bc7aWDxZNvFcEpHiA1M3o";
        String sdkKey = "CoqGNcq4aHK8VwBV8TF3QocCn3mZXqoNt4q3xsB4aTqT";


//        FaceEngine faceEngine = new FaceEngine("D:\\arcsoft_lib");
        FaceEngine faceEngine = new FaceEngine("D:\\face\\ArcSoft_ArcFace_Java_Windows_x64_V3.0\\libs\\WIN64");
        //激活引擎
        ...
        engineConfiguration.setDetectFaceMaxNum(2);
        //识别的最小人脸比例 = 图片长边 / 人脸框长边的比值
        engineConfiguration.setDetectFaceScaleVal(8);
        //功能配置
...
//        functionConfiguration.setSupportIRLiveness(true);
        ...
        ImageInfo imageInfo = getRGBData(new File("D:\\gitrepo\\fushan\\StatusMonitor\\src\\main\\java" +
                "\\com\\whut\\controller\\5.bmp"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("D:\\gitrepo\\fushan\\StatusMonitor\\src\\main\\" +
                "java\\com\\whut\\controller\\3003.bmp"));
...
//        byte[] face1 = targetFaceFeature.getFeatureData();
//        byte[] face2 = sourceFaceFeature.getFeatureData();
//        System.out.println(face1.length);
//
//        System.out.println(Arrays.toString(face1));
////        System.out.println(Arrays.toString(face2));
